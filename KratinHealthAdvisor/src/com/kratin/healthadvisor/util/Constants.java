...
public final class Constants {
	public static final int NORMAL_DIASTOLIC_START=60;
	public static final int NORMAL_DIASTOLIC_END=80;
	public static final int NORMAL_SYSTOLIC_START= 100;
	public static final int NORMAL_SYSTOLIC_END= 120;
	public static final int LOW_SYSTOLIC_START=80;
	public static final int LOW_SYSTOLIC_END=100;
	public static final int LOW_DIASTOLIC_START= 50;
	public static final int LOW_DIASTOLIC_END=70;
	public static final int MAX_SYSTOLIC_START=140;
	public static final int MAX_SYSTOLIC_END= 190;
	public static final int MAX_DIASTOLIC_START=90;
	public static final int MAX_DIASTOLIC_END=100;
	...
	public final class Msg {
		...
		public static final String NORMAL_BP = "Great, Your Blood Pressure is Normal.";
		public static final String LOW_BP = "Critical: Your Blood Pressure is Low, Please Consult your Doctor Immediately";
		public static final String HIGH_BP = "Critical: Your Blood Pressure is High, Please Consult your Doctor Immediately";
		public static final String INVALID_INPUT = "Please enter valid input!";
		
		//Oxygen level Messages
		public static final String NORMAL_OXYGEN = "Great, Your Oxygen Level is Normal";
		public static final String MIN_CONCERN_OXYGEN ="Concerning Blood Oxygen Level , Please Consult Your Doctor";
		public static final String LOW_OXYGEN= "Your Oxygen Level is Low";
		public static final String VERY_LOW_OXYGEN = "Critical: Oxygen Level is very Low ! (Low Oxygen saturation affects your Brain)";
